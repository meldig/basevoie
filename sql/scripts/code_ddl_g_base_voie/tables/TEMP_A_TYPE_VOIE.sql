...
COMMENT ON TABLE G_BASE_VOIE.TEMP_A_TYPE_VOIE IS 'Table rassemblant tous les types de voies présents dans la base voie. Il s''agit d''une table UNIQUEMENT utilisée pour tester la structure teant compte des latéralités ds voies.';
...
COMMENT ON COLUMN G_BASE_VOIE.TEMP_A_TYPE_VOIE.libelle IS 'Libellé des types de voie. Exemple : Boulevard, avenue, rue, sentier, etc.';
