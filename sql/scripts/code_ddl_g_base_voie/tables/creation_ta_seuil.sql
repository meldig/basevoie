...
COMMENT ON COLUMN G_BASE_VOIE.TA_SEUIL.id_troncon IS 'Identifiant du tronçon de la table TA_TRONCON associé au seuil.';
...
COMMENT ON COLUMN G_BASE_VOIE.TA_SEUIL.old_objectid IS 'Champ temporaire servant à l''import des données. Ce champ sera supprimé une fois l''import terminé.';
