...
COMMENT ON COLUMN G_BASE_VOIE.TEMP_VOIE.genre IS 'Genre du nom de la voie : masculin, féminin, neutre et non-identifié.';
...
CREATE INDEX TEMP_VOIE_GENRE_IDX ON G_BASE_VOIE.TEMP_VOIE(genre)
    TABLESPACE G_ADT_INDX;
