...
COMMENT ON COLUMN G_BASE_VOIE.TA_RELATION_TRONCON_SEUIL.objectid IS 'Clé primaire et étrangère vers la table TA_TRONCON permettant d''asocier un tronçons aux seuils.';
COMMENT ON COLUMN G_BASE_VOIE.TA_RELATION_TRONCON_SEUIL.geom IS 'Clé primaire et clé étrangère vers la table TA_SEUIL permettant d''associer un ou plusieurs seuils à un tronçon.';
