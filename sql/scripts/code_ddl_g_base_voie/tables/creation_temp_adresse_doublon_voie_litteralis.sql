...
*/
/*
DROP TABLE G_BASE_VOIE.TEMP_ADRESSE_DOUBLON_VOIE_LITTERALIS CASCADE CONSTRAINTS;
DELETE FROM USER_SDO_GEOM_METADATA WHERE TABLE_NAME = 'TEMP_ADRESSE_DOUBLON_VOIE_LITTERALIS';
*/
