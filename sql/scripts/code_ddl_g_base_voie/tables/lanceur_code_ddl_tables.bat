@echo off
echo Bienvenu dans la création des tables de la Base Voie !
...
:: 5. Suppression du fichier temporaire permettant de créer toutes les tables de la base voie
DEL %chemin_code_ddl%\code_ddl_tables.sql