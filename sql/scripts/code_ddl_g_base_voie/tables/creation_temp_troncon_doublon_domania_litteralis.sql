...
*/
/*
DROP TABLE G_BASE_VOIE.TEMP_TRONCON_DOUBLON_DOMANIA_LITTERALIS CASCADE CONSTRAINTS;
DELETE FROM USER_SDO_GEOM_METADATA WHERE TABLE_NAME = 'TEMP_TRONCON_DOUBLON_DOMANIA_LITTERALIS';
COMMIT;
*/
...
COMMENT ON COLUMN G_BASE_VOIE.TEMP_TRONCON_DOUBLON_DOMANIA_LITTERALIS.CODE_SOUS_TRONCON IS 'Code du sous-tronçon côté DEPV.';
