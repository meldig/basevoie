...
*/
/*
DROP TABLE G_BASE_VOIE.TEMP_TRONCON_CORRECT_LITTERALIS CASCADE CONSTRAINTS;
DELETE FROM USER_SDO_GEOM_METADATA WHERE TABLE_NAME = 'TEMP_TRONCON_CORRECT_LITTERALIS';
COMMIT;
*/
