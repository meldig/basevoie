...
COMMENT ON COLUMN G_BASE_VOIE.TEMP_I_VOIE_PHYSIQUE.FID_ACTION IS 'Champ permettant de savoir s''il faut inverser le sens géométrique de la voie physique ou non.';
...
CREATE INDEX TEMP_I_VOIE_PHYSIQUE_FID_ACTION_IDX ON G_BASE_VOIE.TEMP_I_VOIE_PHYSIQUE(fid_action)
