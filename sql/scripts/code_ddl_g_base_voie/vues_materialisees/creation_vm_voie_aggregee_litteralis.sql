/*
Création de la VM VM_VOIE_AGGREGEE_LITTERALIS aggrégeant les tronçons des voies au format LITTERALIS.
Cette VM est nécessaire à la création des zones particulières du projet LITTERALIS.
*/
