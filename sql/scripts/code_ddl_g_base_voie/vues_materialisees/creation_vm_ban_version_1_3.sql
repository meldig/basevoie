/*
Création de la Vue Matérialisée VM_BAN_VERSION_1_3 proposant les adresses au format BAN (sur les 95 communes).
*/
...
CREATE MATERIALIZED VIEW "G_BASE_VOIE"."VM_BAN_VERSION_1_3" ("UID_ADRESSE", "CLE_INTEROP", "COMMUNE_INSEE", "COMMUNE_NOM", "COMMUNE_DELEGUEE_INSEE", "COMMUNE_DELEGUEE_NOM", "VOIE_NOM", "LIEUDIT_COMPLEMENT_NOM", "NUMERO", "SUFFIXE", "POSITION", "X", "Y", "LONG", "LAT", "CAD_PARCELLES", "SOURCE", "DATE_DER_MAJ", "CERTIFICATION_COMMUNE")
  ...
  FROM
    ...
    INNER JOIN g_base_voie.ta_hierarchisation_voie j ON j.fid_voie_secondaire = e.fid_voie
    INNER JOIN g_base_voie.ta_voie f ON f.objectid = j.fid_voie_principale
...
COMMENT ON MATERIALIZED VIEW "G_BASE_VOIE"."VM_BAN_VERSION_1_3"  IS 'Création de la Vue Matérialisée VM_BAN_VERSION_1_3 proposant les adresses au format BAN (sur les 95 communes)';
