...
-- Mise à jour de la séquence d'incrémentation de la PK de TEMP_F_LIBELLE
SELECT
        MAX(objectid)+1
FROM
    G_BASE_VOIE.TEMP_F_LIBELLE;

ALTER TABLE G_BASE_VOIE.TEMP_F_LIBELLE MODIFY objectid NUMBER(38,0) GENERATED BY DEFAULT AS IDENTITY(START WITH 4 INCREMENT BY 1);
--
