/*
Remplissage de la table G_BASE_VOIE.TEMP_J_VOIE_SUPRA_COMMUNALE.
*/

DROP INDEX TEMP_J_VOIE_SUPRA_COMMUNALE_ID_VOIE_SUPRA_COMMUNALE_IDX;
DROP INDEX TEMP_J_VOIE_SUPRA_COMMUNALE_FID_VOIE_ADMINISTRATIVE_IDX;
DROP INDEX TEMP_J_VOIE_SUPRA_COMMUNALE_DOMANIALITE_SUPRA_COMMUNALE_IDX;
DROP INDEX TEMP_J_VOIE_SUPRA_COMMUNALE_CODE_INSEE_IDX;
DROP INDEX TEMP_J_VOIE_SUPRA_COMMUNALE_SIDX;

/

MERGE INTO G_BASE_VOIE.TEMP_J_VOIE_SUPRA_COMMUNALE a 
	USING(
		WITH
		    C_1 AS(
		        SELECT
