...
-- Mise à jour de la séquence d'incrémentation de la PK de TEMP_H_LIBELLE
SELECT
        MAX(objectid)+1
FROM
    G_BASE_VOIE.TEMP_H_LIBELLE;

ALTER TABLE G_BASE_VOIE.TEMP_H_LIBELLE MODIFY objectid NUMBER(38,0) GENERATED BY DEFAULT AS IDENTITY(START WITH 4 INCREMENT BY 1);
--
...
ON(a.objectid = t.objectid AND a.fid_type_voie = t.fid_type_voie)
WHEN NOT MATCHED THEN
    INSERT(a.objectid, a.geom, a.cote_troncon, a.code_insee, a.date_saisie, a.date_modification, a.fid_pnom_saisie, a.fid_pnom_modification, a.fid_troncon)
    VALUES(t.objectid, t.geom, t.cote_troncon, t.code_insee, t.date_saisie, t.date_modification, t.fid_pnom_saisie, t.fid_pnom_modification, t.fid_troncon);
COMMIT;
-- Résultat : 
