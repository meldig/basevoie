@echo off
echo Bienvenu dans la creation des tables, vues, VM, fonctions, sequences et declencheurs du projet C de correction de la Base Voie !
...
copy /b %chemin_code_sequence%\creation_seq_temp_f_troncon_objectid.sql + ^
%chemin_code_table%\creation_temp_f_agent.sql + ^
%chemin_code_table%\creation_temp_f_libelle.sql + ^
%chemin_code_table%\creation_temp_f_type_voie.sql + ^
%chemin_code_table%\creation_temp_f_voie.sql + ^
%chemin_code_table%\creation_temp_f_voie_physique.sql + ^
%chemin_code_table%\creation_temp_f_voie_administrative.sql + ^
%chemin_code_table%\creation_temp_f_troncon.sql + ^
%chemin_code_table%\creation_temp_f_relation_voie_physique_administrative.sql + ^
%chemin_code_trigger%\creation_b_iux_temp_f_troncon_date_pnom.sql + ^
%chemin_code_temp%\desactivation_contraintes_index_tables_projet_f.sql ^
%chemin_code_temp%\temp_code_ddl_schema_transitoire_projet_f.sql
