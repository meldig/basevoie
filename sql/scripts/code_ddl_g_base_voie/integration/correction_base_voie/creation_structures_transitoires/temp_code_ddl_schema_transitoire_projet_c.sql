...
COMMENT ON COLUMN G_BASE_VOIE.TEMP_C_RELATION_TRONCON_VOIE_PHYSIQUE.old_id_voie_physique IS 'Champ transitoire permettant de sauvegarder l''ancien id voie physique.';
...
ALTER TABLE G_BASE_VOIE.TEMP_C_TRONCON DISABLE CONSTRAINT TEMP_C_TRONCON_FID_PNOM_SAISIE_FK;
ALTER TABLE G_BASE_VOIE.TEMP_C_TRONCON DISABLE CONSTRAINT TEMP_C_TRONCON_FID_PNOM_MODIFICATION_FK;
ALTER TABLE G_BASE_VOIE.TEMP_C_TRONCON DISABLE CONSTRAINT TEMP_C_TRONCON_FID_ETAT_FK;
...
DROP INDEX TEMP_C_RELATION_TRONCON_VOIE_PHYSIQUE_FID_TRONCON_IDX;
DROP INDEX TEMP_C_RELATION_TRONCON_VOIE_PHYSIQUE_FID_VOIE_PHYSIQUE_IDX;
DROP INDEX TEMP_C_RELATION_VOIE_PHYSIQUE_ADMINISTRATIVE_FID_VOIE_ADMINISTRATIVE_IDX;
DROP INDEX TEMP_C_RELATION_VOIE_PHYSIQUE_ADMINISTRATIVE_FID_VOIE_PHYSIQUE_IDX;
