...
copy /b %chemin_code_sequence%\creation_seq_temp_c_troncon_objectid.sql + ^
%chemin_code_table%\creation_temp_c_agent.sql + ^
%chemin_code_table%\creation_temp_c_libelle.sql + ^
%chemin_code_table%\creation_temp_c_type_voie.sql + ^
%chemin_code_table%\creation_temp_c_voie.sql + ^
%chemin_code_table%\creation_temp_c_voie_physique.sql + ^
%chemin_code_table%\creation_temp_c_voie_administrative.sql + ^
