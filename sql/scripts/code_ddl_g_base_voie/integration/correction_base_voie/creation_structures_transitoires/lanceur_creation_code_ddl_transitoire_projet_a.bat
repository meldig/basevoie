...
%chemin_code_temp%\desactivation_contraintes_index_projet_a.sql ^
%chemin_code_temp%\temp_code_ddl_structure_projet_a.sql

:: 3. lancement de SQL plus.
::CD C:/ora12c/R1/BIN

:: 4. Execution de sqlplus. pour lancer les requetes SQL.
::sqlplus.exe %USER%/%MDP%@%INSTANCE% @%chemin_code_temp%\temp_code_ddl_structure_projet_a.sql
