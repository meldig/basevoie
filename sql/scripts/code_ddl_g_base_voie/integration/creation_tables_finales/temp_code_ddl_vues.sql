...
REFRESH FORCE
START WITH TO_DATE('26-05-2023 10:00:00', 'dd-mm-yyyy hh24:mi:ss')
...
CREATE INDEX VM_AUDIT_CODE_INSEE_SEUIL_EN_ERREUR_GEOM_IDX ON G_BASE_VOIE.VM_AUDIT_CODE_INSEE_SEUIL_EN_ERREUR(GEOM)
    TABLESPACE G_ADT_INDX;
