...
DROP TABLE G_BASE_VOIE.TA_RELATION_VOIE_ADMINISTRATIVE_SUPPRA_COMMUNALE CASCADE CONSTRAINTS;
...
DROP TABLE G_BASE_VOIE.TA_VOIE_SUPPRA_COMMUNALE CASCADE CONSTRAINTS;
...
DELETE FROM USER_SDO_GEOM_METADATA
WHERE TABLE_NAME = 'VM_CONSULTATION_TRONCON_VOIE_SUPRA_COMMUNALE';
