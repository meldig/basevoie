...
DELETE FROM USER_SDO_GEOM_METADATA 
WHERE TABLE_NAME = 'VM_TRAVAIL_VOIE_AGGREGEE_CODE_INSEE';

DELETE FROM USER_SDO_GEOM_METADATA 
WHERE TABLE_NAME = 'VM_TRAVAIL_VOIE_CODE_INSEE_LONGUEUR';

DELETE FROM USER_SDO_GEOM_METADATA 
WHERE TABLE_NAME = 'VM_TRAVAIL_VOIE_PRINCIPALE_LONGUEUR';

DELETE FROM USER_SDO_GEOM_METADATA 
WHERE TABLE_NAME = 'VM_TRAVAIL_VOIE_SECONDAIRE_LONGUEUR';
