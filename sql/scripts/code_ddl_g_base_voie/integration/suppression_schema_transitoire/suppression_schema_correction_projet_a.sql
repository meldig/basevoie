...
DROP VIEW G_BASE_VOIE.V_TEMP_VOIE_AGREGEE_SENS_CIRCULATION_RECTIFIE;

-- 3. Suppression des vues matérialisées
...
DELETE FROM USER_SDO_GEOM_METADATA
WHERE TABLE_NAME = 'V_TEMP_VOIE_AGREGEE_SENS_CIRCULATION_RECTIFIE';

-- 5. Suppression des séquences
DROP SEQUENCE SEQ_TEMP_A_TRONCON_OBJECTID;

-- 6. Suppression des fonctions
