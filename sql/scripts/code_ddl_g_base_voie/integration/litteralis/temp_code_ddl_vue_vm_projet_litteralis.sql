...
WITH
   ...
   C_6 AS(-- Mise en forme des tron�ons ayant une seule domanialit� et compilation avec ceux disposant de deux domanialit�s dans les tables source 
        SELECT DISTINCT --Le DISTINCT est indispensable car certains tron�ons peuvent �tre compos�s de plusieurs sous-tron�ons de m�me domanialit�
            d.id_troncon,
        ...
        UNION ALL
        SELECT DISTINCT -- S�lection des tron�ons n'ayant pas de domanialit� - dans ce cas le classement est 'VC'
            a.id_troncon,
