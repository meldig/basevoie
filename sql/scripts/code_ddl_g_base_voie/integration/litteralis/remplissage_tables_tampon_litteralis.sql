...
BEGIN
    ...
    EXECUTE IMMMEDIATE 'ALTER TABLE G_BASE_VOIE.TA_TAMPON_LITTERALIS_CORRESPONDANCE_DOMANIALITE_CLASSEMENT MODIFY OBJECTID NUMBER(38,0) GENERATED BY DEFAULT AS IDENTITY(START WITH 1 INCREMENT BY 1)';
    EXECUTE IMMMEDIATE 'ALTER TABLE G_BASE_VOIE.TA_TAMPON_LITTERALIS_ZONE_PARTICULIERE MODIFY OBJECTID NUMBER(38,0) GENERATED BY DEFAULT AS IDENTITY(START WITH 1 INCREMENT BY 1)';
...
INSERT INTO G_BASE_VOIE.TA_TAMPON_LITTERALIS_ZONE_PARTICULIERE(type_zone, id_voie, code_voie, cote_voie, code_insee, categorie, geometry)
    SELECT -- Sélection des voies entièrement incluses dans les zones d''agglomération
    ...
    UNION ALL
    SELECT -- Pour toutes les voies intersectant les zones d'agglomération, on sélectionne uniquement la partie située à l''intérieur des zones
        'Agglomération' AS type_zone,
        a.id_voie,
        a.code_voie,
        a.cote_voie,
...
-- Résultat : 20 094 lignes insérées

-- Insertion des zones particulières hors agglomération
INSERT INTO G_BASE_VOIE.TA_TAMPON_LITTERALIS_ZONE_PARTICULIERE(type_zone, id_voie, code_voie, cote_voie, code_insee, categorie, geometry)
...
-- Résultat : 5 257 lignes insérées
