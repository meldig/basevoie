...
:: 5.10. table VOIECVT
ogr2ogr.exe -f OCI OCI:%USER_D%/%MDP_D%@%INSTANCE_D% OCI:%USER_P%/%MDP_P%@%INSTANCE_P%:TA_RUE -sql "SELECT * FROM G_SIDU.TA_RUE" -nln TEMP_TA_RUE

:: 5.11. table VOIECVT
ogr2ogr.exe -f OCI OCI:%USER_D%/%MDP_D%@%INSTANCE_D% OCI:%USER_P%/%MDP_P%@%INSTANCE_P%:TA_RUEVOIE -sql "SELECT * FROM G_SIDU.TA_RUEVOIE" -nln TEMP_TA_RUEVOIE
