...
-- 2.1. TEMP_ILTASEU
CREATE OR REPLACE TRIGGER B_IUD_TEMP_ILTASEU_NO_DELETE
...
-- 2.2. TEMP_ILTATRC
CREATE OR REPLACE TRIGGER B_IUD_TEMP_ILTATRC_NO_DELETE
...
-- 2.3. TEMP_ILTASIT
CREATE OR REPLACE TRIGGER B_IUD_TEMP_ILTASIT_NO_DELETE
...
-- 2.4. TEMP_VOIECVT
CREATE OR REPLACE TRIGGER B_IUD_TEMP_VOIECVT_NO_DELETE
...
-- 2.4. TEMP_VOIEVOI
CREATE OR REPLACE TRIGGER B_IUD_TEMP_VOIEVOI_NO_DELETE
...
-- 2.4. TEMP_TYPEVOIE
CREATE OR REPLACE TRIGGER B_IUD_TEMP_TYPEVOIE_NO_DELETE
...
-- 2.4. TEMP_ILTAPTZ
CREATE OR REPLACE TRIGGER B_IUD_TEMP_ILTAPTZ_NO_DELETE
...
-- 2.4. TEMP_ILTADTN
CREATE OR REPLACE TRIGGER B_IUD_TEMP_ILTADTN_NO_DELETE
...
-- 2.4. TEMP_ILTAFILIA
CREATE OR REPLACE TRIGGER B_IUD_TEMP_ILTAFILIA_NO_DELETE
...
CREATE OR REPLACE TRIGGER B_IUD_TEMP_FUSION_SEUIL_NO_DELETE
...
-- 2.4. TEMP_ILTALPU
CREATE OR REPLACE TRIGGER B_IUD_TEMP_ILTALPU_NO_DELETE
...
CREATE OR REPLACE TRIGGER B_IUD_TEMP_CODE_FANTOIR_NO_DELETE
