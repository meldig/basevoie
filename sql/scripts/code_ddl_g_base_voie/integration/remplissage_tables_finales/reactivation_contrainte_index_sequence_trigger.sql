...
BEGIN
	...
	FROM
    	...
    	EXECUTE IMMEDIATE 'ALTER TABLE G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE MODIFY OBJECTID NUMBER(38,0) GENERATED BY DEFAULT AS IDENTITY (START WITH ' ||id_max|| ' INCREMENT BY 1)';
	...
	EXECUTE IMMEDIATE 'CREATE INDEX G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE_DATE_EDITION_IDX ON G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE (date_edition) TABLESPACE G_ADT_INDX';
	...
	EXECUTE IMMEDIATE 'ALTER TRIGGER B_IUX_TA_MISE_A_JOUR_A_FAIRE';
