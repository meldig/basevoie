...
DECLARE
	id_max NUMBER(38,0);
BEGIN
	-- Reinitialisation des sequences nommees
	SELECT
		MAX(objectid)+1
		INTO id_max
	FROM
	...
	SELECT
		...
		INTO id_max
	FROM
		G_BASE_VOIE.TA_VOIE_PHYSIQUE_LOG;

	EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_TA_VOIE_PHYSIQUE_LOG_OBJECTID START WITH '||id_max||' INCREMENT BY 1';
	...
	FROM
    	...
    	EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_TA_TRONCON_LOG_OBJECTID START WITH '||id_max||' INCREMENT BY 1';
    ...
    SELECT
		...
		INTO id_max
	FROM
		G_BASE_VOIE.TA_VOIE_SUPRA_COMMUNALE_LOG;
        
    	EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_TA_VOIE_SUPRA_COMMUNALE_LOG_OBJECTID START WITH '||id_max||' INCREMENT BY 1';
    
    SELECT
		MAX(objectid)+1
		INTO id_max
	FROM
		G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE;
        
    	EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_TA_MISE_A_JOUR_A_FAIRE_OBJECTID START WITH '||id_max||' INCREMENT BY 1';
	...
	FROM
    	...
    	EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_TA_VOIE_ADMINISTRATIVE_OBJECTID START WITH '||id_max||' INCREMENT BY 1';
    
	SELECT
		MAX(objectid)+1
		INTO id_max
	FROM
		G_BASE_VOIE.TA_VOIE_ADMINISTRATIVE_LOG;

    	EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_TA_VOIE_ADMINISTRATIVE_LOG_OBJECTID START WITH '||id_max||' INCREMENT BY 1';
	...
	FROM
    	...
    	EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_TA_SEUIL_OBJECTID START WITH '||id_max||' INCREMENT BY 1';
	...
	FROM
    	...
    	EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_TA_SEUIL_LOG_OBJECTID START WITH '||id_max||' INCREMENT BY 1';
	...
	FROM
    	...
    	EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_TA_INFOS_SEUIL_OBJECTID START WITH '||id_max||' INCREMENT BY 1';
	...
	FROM
    	...
    	EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_TA_INFOS_SEUIL_LOG_OBJECTID START WITH '||id_max||' INCREMENT BY 1';
	...
	FROM
    	...
    	EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_TA_RELATION_VOIE_PHYSIQUE_ADMINISTRATIVE_OBJECTID START WITH '||id_max||' INCREMENT BY 1';

	SELECT
		MAX(objectid)+1
		INTO id_max
	FROM
		G_BASE_VOIE.TA_RELATION_VOIE_PHYSIQUE_ADMINISTRATIVE_LOG;

    	EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_TA_RELATION_VOIE_PHYSIQUE_ADMINISTRATIVE_LOG_OBJECTID START WITH '||id_max||' INCREMENT BY 1';
	...
	FROM
    	...
    	EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_TA_LIBELLE_OBJECTID START WITH '||id_max||' INCREMENT BY 1';
	...
	FROM
    	...
    	EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_TA_TYPE_VOIE_OBJECTID START WITH '||id_max||' INCREMENT BY 1';
	...
	FROM
    	...
    	EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_TA_RIVOLI_OBJECTID START WITH '||id_max||' INCREMENT BY 1';
	...
	EXECUTE IMMEDIATE 'ALTER TABLE G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE ENABLE CONSTRAINT TA_MISE_A_JOUR_A_FAIRE_FID_PNOM_SAISIE_FK';
	EXECUTE IMMEDIATE 'ALTER TABLE G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE ENABLE CONSTRAINT TA_MISE_A_JOUR_A_FAIRE_FID_PNOM_MODIFICATION_FK';
	EXECUTE IMMEDIATE 'ALTER TABLE G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE ENABLE CONSTRAINT TA_MISE_A_JOUR_A_FAIRE_FID_LATERALITE_FK';
	...
	EXECUTE IMMEDIATE 'CREATE INDEX G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE_SIDX ON G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE (geom) INDEXTYPE IS "MDSYS"."SPATIAL_INDEX_V2"  PARAMETERS (''sdo_indx_dims=2, layer_gtype=POINT, tablespace=G_ADT_INDX, work_tablespace=DATEMP_I_TEMP'')';
	EXECUTE IMMEDIATE 'CREATE INDEX G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE_ID_SEUIL_IDX ON G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE (id_seuil) TABLESPACE G_ADT_INDX';
	EXECUTE IMMEDIATE 'CREATE INDEX G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE_ID_TRONCON_IDX ON G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE (id_troncon) TABLESPACE G_ADT_INDX';
	EXECUTE IMMEDIATE 'CREATE INDEX G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE_ID_VOIE_ADMINISTRATIVE_IDX ON G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE (id_voie_administrative) TABLESPACE G_ADT_INDX';
	EXECUTE IMMEDIATE 'CREATE INDEX G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE_CODE_INSEE_IDX ON G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE (code_insee) TABLESPACE G_ADT_INDX';
	EXECUTE IMMEDIATE 'CREATE INDEX G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE_DATE_SAISIE_IDX ON G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE (date_saisie) TABLESPACE G_ADT_INDX';
	EXECUTE IMMEDIATE 'CREATE INDEX G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE_DATE_MODIFICATION_IDX ON G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE (date_MODIFICATION) TABLESPACE G_ADT_INDX';
	EXECUTE IMMEDIATE 'CREATE INDEX G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE_FID_PNOM_MODIFICATION_IDX ON G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE (fid_pnom_modification) TABLESPACE G_ADT_INDX';
	EXECUTE IMMEDIATE 'CREATE INDEX G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE_FID_PNOM_SAISIE_IDX ON G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE (fid_pnom_saisie) TABLESPACE G_ADT_INDX';
	EXECUTE IMMEDIATE 'CREATE INDEX G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE_FID_ETAT_AVANCEMENT_IDX ON G_BASE_VOIE.TA_MISE_A_JOUR_A_FAIRE (fid_etat_avancement) TABLESPACE G_ADT_INDX';
	...
	EXECUTE IMMEDIATE 'ALTER TRIGGER B_IUX_TA_MISE_A_JOUR_A_FAIRE ENABLE';

	-- Reactivation du droit sur les sequences:
	EXECUTE IMMEDIATE 'GRANT SELECT ON G_BASE_VOIE.SEQ_TA_TRONCON_OBJECTID TO G_BASE_VOIE_LEC';
	EXECUTE IMMEDIATE 'GRANT SELECT ON G_BASE_VOIE.SEQ_TA_TRONCON_OBJECTID TO G_BASE_VOIE_MAJ';
	EXECUTE IMMEDIATE 'GRANT SELECT ON G_BASE_VOIE.SEQ_TA_VOIE_PHYSIQUE_OBJECTID TO G_BASE_VOIE_LEC';
	EXECUTE IMMEDIATE 'GRANT SELECT ON G_BASE_VOIE.SEQ_TA_VOIE_PHYSIQUE_OBJECTID TO G_BASE_VOIE_MAJ';
	EXECUTE IMMEDIATE 'GRANT SELECT ON G_BASE_VOIE.SEQ_TA_VOIE_SUPRA_COMMUNALE_OBJECTID TO G_BASE_VOIE_LEC';
	EXECUTE IMMEDIATE 'GRANT SELECT ON G_BASE_VOIE.SEQ_TA_VOIE_SUPRA_COMMUNALE_OBJECTID TO G_BASE_VOIE_MAJ';
	EXECUTE IMMEDIATE 'GRANT SELECT ON G_BASE_VOIE.SEQ_TA_SEUIL_OBJECTID TO G_BASE_VOIE_LEC';
	EXECUTE IMMEDIATE 'GRANT SELECT ON G_BASE_VOIE.SEQ_TA_SEUIL_OBJECTID TO G_BASE_VOIE_MAJ';
	EXECUTE IMMEDIATE 'GRANT SELECT ON G_BASE_VOIE.SEQ_TA_VOIE_ADMINISTRATIVE_OBJECTID TO G_BASE_VOIE_LEC';
	EXECUTE IMMEDIATE 'GRANT SELECT ON G_BASE_VOIE.SEQ_TA_VOIE_ADMINISTRATIVE_OBJECTID TO G_BASE_VOIE_MAJ';
	EXECUTE IMMEDIATE 'GRANT SELECT ON G_BASE_VOIE.SEQ_TA_MISE_A_JOUR_A_FAIRE_OBJECTID TO G_BASE_VOIE_LEC';
	EXECUTE IMMEDIATE 'GRANT SELECT ON G_BASE_VOIE.SEQ_TA_MISE_A_JOUR_A_FAIRE_OBJECTID TO G_BASE_VOIE_MAJ';
	EXECUTE IMMEDIATE 'GRANT SELECT ON G_BASE_VOIE.SEQ_TA_RELATION_VOIE_PHYSIQUE_ADMINISTRATIVE_OBJECTID TO G_BASE_VOIE_LEC';
	EXECUTE IMMEDIATE 'GRANT SELECT ON G_BASE_VOIE.SEQ_TA_RELATION_VOIE_PHYSIQUE_ADMINISTRATIVE_OBJECTID TO G_BASE_VOIE_MAJ';
