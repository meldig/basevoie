...
BEGIN
    ...
    */
    ...
    EXECUTE IMMEDIATE 'CREATE INDEX TEMP_ILTASIT_IDSEUI_IDX ON G_BASE_VOIE.TEMP_ILTASIT(idseui) TABLESPACE G_ADT_INDX';
    EXECUTE IMMEDIATE 'CREATE INDEX TEMP_ILTASIT_CNUMTRC_IDX ON G_BASE_VOIE.TEMP_ILTASIT(cnumtrc) TABLESPACE G_ADT_INDX';
    EXECUTE IMMEDIATE 'CREATE INDEX TEMP_ILTATRC_CNUMTRC_IDX ON G_BASE_VOIE.TEMP_ILTATRC(cnumtrc) TABLESPACE G_ADT_INDX';  
    EXECUTE IMMEDIATE 'CREATE INDEX TEMP_VOIECVT_CNUMTRC_IDX ON G_BASE_VOIE.TEMP_VOIECVT(cnumtrc) TABLESPACE G_ADT_INDX'; 
    EXECUTE IMMEDIATE 'CREATE INDEX TEMP_VOIECVT_CCOMVOI_IDX ON G_BASE_VOIE.TEMP_VOIECVT(ccomvoi) TABLESPACE G_ADT_INDX';
    EXECUTE IMMEDIATE 'CREATE INDEX TEMP_VOIEVOI_CCOMVOI_IDX ON G_BASE_VOIE.TEMP_VOIEVOI(ccomvoi) TABLESPACE G_ADT_INDX';
    EXECUTE IMMEDIATE 'CREATE INDEX TEMP_TYPEVOIE_CCODTVO_IDX ON G_BASE_VOIE.TEMP_TYPEVOIE(ccodtvo) TABLESPACE G_ADT_INDX';
...
-- 38. Insertion des points d'intérêt
    ...
    -- 42. Recréation des index
    EXECUTE IMMEDIATE 'CREATE INDEX TA_VOIE_FID_PNOM_SAISIE_IDX ON G_BASE_VOIE.TA_VOIE(fid_pnom_saisie) TABLESPACE G_ADT_INDX';
    EXECUTE IMMEDIATE 'CREATE INDEX TA_VOIE_FID_PNOM_MODIFICATION_IDX ON G_BASE_VOIE.TA_VOIE(fid_pnom_modification) TABLESPACE G_ADT_INDX';
    EXECUTE IMMEDIATE 'CREATE INDEX TA_VOIE_FID_TYPEVOIE_IDX ON G_BASE_VOIE.TA_VOIE(fid_typevoie) TABLESPACE G_ADT_INDX';
    EXECUTE IMMEDIATE 'CREATE INDEX TA_VOIE_FID_GENRE_VOIE_IDX ON G_BASE_VOIE.TA_VOIE(fid_genre_voie) TABLESPACE G_ADT_INDX';
    EXECUTE IMMEDIATE 'CREATE INDEX TA_VOIE_FID_RIVOLI_IDX ON G_BASE_VOIE.TA_VOIE(fid_rivoli) TABLESPACE G_ADT_INDX';
    EXECUTE IMMEDIATE 'CREATE INDEX TA_VOIE_FID_METADONNEE_IDX ON G_BASE_VOIE.TA_VOIE(fid_metadonnee) TABLESPACE G_ADT_INDX';
    ...
    EXECUTE IMMEDIATE 'CREATE INDEX TA_TRONCON_FID_VOIE_IDX ON G_BASE_VOIE.TA_TRONCON(fid_voie) TABLESPACE G_ADT_INDX';
    EXECUTE IMMEDIATE 'CREATE INDEX TA_TRONCON_FID_METADONNEE_IDX ON G_BASE_VOIE.TA_TRONCON(fid_metadonnee) TABLESPACE G_ADT_INDX';
