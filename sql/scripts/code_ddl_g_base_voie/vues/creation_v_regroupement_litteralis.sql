  ...
  CREATE OR REPLACE FORCE VIEW "G_BASE_VOIE"."V_REGROUPEMENT_LITTERALIS" ("TYPE", "NOM", "CODE_REGR", "CODE_INSEE", "GEOMETRY", 
	 CONSTRAINT "V_REGROUPEMENT_PK" PRIMARY KEY ("CODE_REGR") DISABLE) AS 
  (
    SELECT
       'Commune' AS TYPE,
        a.nom AS NOM,
        a.code_adm AS CODE_REGR,
    ...
    SELECT
        ...
        CAST(a.codesouster AS VARCHAR2(24)) AS CODE_REGR,
        null AS CODE_INSEE,
        CASE
   ...
   COMMENT ON COLUMN "G_BASE_VOIE"."V_REGROUPEMENT_LITTERALIS"."CODE_REGR" IS 'Identificateur unique et immuable du regroupement partagé entre Littéralis Expert et le SIG.';
