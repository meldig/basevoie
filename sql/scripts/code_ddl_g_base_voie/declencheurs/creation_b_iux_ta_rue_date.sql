create or replace TRIGGER G_BASE_VOIE.B_IUX_TA_RUE_DATE
...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            mail.sendmail('bjacq@lillemetropole.fr',SQLERRM,'ERREUR TRIGGER - B_IUX_TA_RUE_DATE','bjacq@lillemetropole.fr');
END;