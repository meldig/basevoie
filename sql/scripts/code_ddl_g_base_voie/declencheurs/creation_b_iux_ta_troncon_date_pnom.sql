...
/*
Création du déclencheur B_IUX_TA_TRONCON_DATE_PNOM permettant de récupérer dans la table TA_LIBELLE, les dates de création/modification des entités ainsi que le pnom de l'agent les ayant effectués.
*/
