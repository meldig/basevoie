/*
Création du déclencheur B_IUX_TA_VOIE_ADMINISTRATIVE permettant de renseigner les dates et pnom de saisie/modification des voies administratives et de créer une nouvelle voie physique à la création d'une voie administrative.
*/

CREATE OR REPLACE TRIGGER G_BASE_VOIE.B_IUX_TA_VOIE_ADMINISTRATIVE
...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            mail.sendmail('bjacq@lillemetropole.fr',SQLERRM || ' Erreur provoquée par ' || username || ' à ' || sysdate,'ERREUR TRIGGER - B_IUX_TA_VOIE_ADMINISTRATIVE','bjacq@lillemetropole.fr');
END;
