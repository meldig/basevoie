...
/*
DROP INDEX VM_AUDIT_SEUIL_HORS_MEL_SIDX;
DELETE FROM USER_SDO_GEOM_METADATA WHERE TABLE_NAME = 'VM_AUDIT_SEUIL_HORS_MEL';
DROP MATERIALIZED VIEW VM_AUDIT_SEUIL_HORS_MEL;
*/
