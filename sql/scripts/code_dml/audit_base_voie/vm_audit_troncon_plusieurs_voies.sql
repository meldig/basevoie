...
/*
DROP INDEX VM_AUDIT_TRONCON_PLUSIEURS_VOIES_SIDX;
DELETE FROM USER_SDO_GEOM_METADATA WHERE TABLE_NAME = 'VM_AUDIT_TRONCON_PLUSIEURS_VOIES';
DROP MATERIALIZED VIEW VM_AUDIT_TRONCON_PLUSIEURS_VOIES;
*/
