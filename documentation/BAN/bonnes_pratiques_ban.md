# Les bonnes pratiques conseillées par l'ANCT
...
- La numérotation doit se faire par la commune lors du dépôt de permis de construire ;
...
![numerotation dent creuse](image/numerotation_dent_creuse.png) 
